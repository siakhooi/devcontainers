...
| fzf             | finder         | curl            | curl            | curl          | curl          |                        |
...
### Cloud Tooling
| Component       | type           | gcloud | Remark                 |
| --------------- | -------------- | ------ | ---------------------- |
| gcloud          | cloud cli      | (base) |                        |
| just            | build          | curl   |                        |
| docker          | container      | apt    |                        |
| curl            | http           | apt    |                        |
| gnupg           | crypto         | apt    |                        |
...
| Component        | type      | jdk21 | jdk25 | jdk25_2604 | go126 | go126_2604 | go127 | python314 | nodejs24 |
| ---------------- | --------- | ----- | ----- | ---------- | ----- | ---------- | ----- | --------- | -------- |
| jdk 21           | lang      | curl  | -     | -          | -     | -          | -     | -         | -        |
